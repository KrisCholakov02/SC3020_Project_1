...
public:
    ...
    void setBlockSize(int size) {
        ...
        int maximumRecords = floor((size - 12) /
                                   40); // need to minus 12 for the  cos of the attributes of Block struc (maxRecords is an int thats 4 bytes long, so is BlockSize)
